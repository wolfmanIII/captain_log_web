        ...
        switch ($detailCode) {
            case 'CHARTER':
                ...
                $map = array_merge($map, [
                    ...
                    '{{DELIVERY_PROOF_REF}}' => $this->fallback($d?->getDeliveryProofRef()),
                    '{{DELIVERY_PROOF_DATE}}' => $this->formatDayYear($d?->getDeliveryProofDay(), $d?->getDeliveryProofYear()),
                    '{{DELIVERY_PROOF_RECEIVED_BY}}' => $this->fallback($d?->getDeliveryProofReceivedBy()),
