        ...
        switch ($detailCode) {
            ...
            case 'PRIZE':
                ...
                $map = array_merge($map, [
                    ...
                    '{{AUTHORITY_NAME}}' => $this->fallback($localLaw?->getShortDescription()),
                    '{{AUTHORITY_SIGN}}' => $this->fallback($localLaw?->getDescription()),
                    '{{CASE_REF}}' => $this->fallback($d?->getCaseRef()),
                    '{{JURISDICTION}}' => $this->fallback($localLaw?->getCode()),
