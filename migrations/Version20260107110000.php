...
final class Version20260107110000 extends AbstractMigration
{
    ...
    {
        return 'Aggiunge signing_location a income';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE income ADD signing_location VARCHAR(255) DEFAULT NULL');
    }

    public function down(Schema $schema): void
    {
        // Non si rimuove la colonna per evitare perdita dati su ambienti condivisi.
    }
}
