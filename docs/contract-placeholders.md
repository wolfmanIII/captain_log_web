...
- **MAIL**: CARRIER_NAME/SIGN, VESSEL_NAME, ORIGIN→DESTINATION, DISPATCH/DELIVERY, MAIL_TYPE, PACKAGE_COUNT, TOTAL_MASS, SECURITY_LEVEL, SEAL_CODES, PAYMENT_TERMS, PROOF_OF_DELIVERY, LIABILITY_LIMIT, NOTES.
